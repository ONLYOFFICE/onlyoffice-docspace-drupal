...
use Drupal\onlyoffice_docspace\OnlyofficeDocumentHelper;
use Drupal\onlyoffice_docspace\OnlyofficeUrlHelper;
use Drupal\onlyoffice_docspace\OnlyofficeAppConfig;
...
class OnlyofficeEditorController extends ControllerBase {
   ...
   *
   * @var \Drupal\onlyoffice_docspace\OnlyofficeDocumentHelper
   */
   ...
   *   The renderer service.
   * @param \Drupal\onlyoffice_docspace\OnlyofficeDocumentHelper $document_helper
   *   The onlyoffice document helper service.
